          ...
          <div className=' bg-homeBG bgImage h-[`900px]' id='Home'>
            <div className='flex justify-between pt-2'>
              {full &&(
                ...
                <div>
                  <div className={color?  'navbarBG flex relative justify-between pt-4 navbar pb-6' : 'bg-transparent flex relative justify-between pt-4 navbar'}>
                    <img
                        src='./assets/Logo.svg'
                        alt='logo'
              ...
              {small &&(
                <div className={color?  'navbarBG navbarsm flex flex-row justify-between pb-6' : 'bg-transparent navbarsm flex flex-row justify-between'}>
                    <img
                    src='./assets/Logo.svg'
                    alt='logo'
