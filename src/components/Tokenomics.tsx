        ...
        {full &&(
            <div className=' pt-10'>
                <div className="relative h-[1450px] mt-6">
                    <div className="absolute top-0 left-[425px] ">
                    ...
                    <div className=" bg-homeBG h-[90%]">
                        ...
                        <div className=' firstProjectBack bg-FirstProjectBGColor shadow-outline-bottom-first  w-[976px] h-[367px] mt-20 rounded-[39.53px] ml-[420px]'>
